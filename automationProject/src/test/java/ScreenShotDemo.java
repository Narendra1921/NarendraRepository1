...
public class ScreenShotDemo {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver,","./driversfolder/chomedriver.exe");
		...
		password.sendKeys("maruqEj");
		//WebElement btnLogin=driver.findElement(By.xpath("//button[@btn=\"btnLogin\"]"));
		//btnLogin.click();
